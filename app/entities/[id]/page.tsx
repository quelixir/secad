    ...
    if (entity) {
      ...
      const transformedEntity = {
        ...
        incorporationDate: entity.incorporationDate
          ? new Date(entity.incorporationDate)
          : null,
            ...
            {selectedEntity?.id === entity.id && (
              <>
                ...
                <TabsTrigger value="securities">
                  Securities ({entity._count?.securityClasses || 0})
                </TabsTrigger>
              </>
            )}
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Legal identifiers for this entity across different
                  jurisdictions
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      {entity.identifiers.map(
                        (identifier: EntityIdentifier) => (
                          <TableRow key={identifier.id}>
                            <TableCell>
                              <CountryWithFlag
                                countryName={getCountryName(identifier.country)}
                              />
                            </TableCell>
                            <TableCell>
                            ...
                            <TableCell>
                              <Badge
                                variant={
                                  identifier.isActive ? "default" : "secondary"
                                }
                              >
                    ...
                    {!entity.address &&
                      ...
                      !entity.country && (
                        <div className="text-sm text-muted-foreground italic">
                          No address information recorded yet
                        </div>
                      )}
                  </div>
                        ...
                        {entity.members.map((member) => {
                          ...
                          return (
                            <TableRow key={member.id}>
                              <TableCell>
                                <Link
                                  href={`/registry/members/${member.id}`}
          ...
          {selectedEntity?.id === entity.id && (
            <TabsContent value="securities" className="space-y-4">
              <Card>
                ...
                <CardContent>
                  {!entity.securityClasses ||
                  entity.securityClasses.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
