...
export default function RegistryPage() {
    ...
    const fetchRegistrySummary = async () => {
        try {
            setLoading(true)
            const response = await fetch(`/api/registry/summary?entityId=${selectedEntity?.id}`)
                ...
                <div className="space-y-8">
                    <div className="text-center py-12">
                        ...
                        <p className="text-muted-foreground mb-6">
                            Please select an entity from the dropdown in the navigation bar to view registry information.
                        </p>
                    </div>
                </div>
            </MainLayout>
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Manage securities, members, and transactions for {selectedEntity.name}
                    </p>
                </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-center py-8 text-muted-foreground">
                                    ...
                                    <p>Click &quot;View All Securities&quot; to manage security classes</p>
                                </div>
                            </CardContent>
                        </Card>
                    </TabsContent>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-center py-8 text-muted-foreground">
                                    ...
                                    <p>Click &quot;View All Members&quot; to manage registry members</p>
                                </div>
                            </CardContent>
                        </Card>
                    </TabsContent>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-center py-8 text-muted-foreground">
                                    ...
                                    <p>Click &quot;View All&quot; to see transactions or &quot;New Transaction&quot; to create one</p>
                                </div>
                            </CardContent>
                        </Card>
                    </TabsContent>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-center py-8 text-muted-foreground">
                                    ...
                                    <p>Click &quot;View Event Log&quot; to see the complete audit trail</p>
                                </div>
                            </CardContent>
                        </Card>
                    </TabsContent>
