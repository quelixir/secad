...
export function TransactionForm({ entities, selectedEntity, transaction, onSaved }: TransactionFormProps) {
  ...
  const form = useForm<TransactionFormValues>({
    ...
    defaultValues: {
      ...
      reasonCode: '', // We'll need to add this field to the transaction model
      ...
      currency: 'AUD', // We'll need to add this field to the transaction model
  ...
  const onSubmit = async (values: TransactionFormValues) => {
    try {
      ...
      const requestData = {
        ...values,
        transactionType: values.type, // Map form 'type' to API 'transactionType'
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  {selectedEntity ? (
                    <div className="flex items-center space-x-2 p-3 bg-muted rounded-md min-h-[40px]">
          ...
          <div className="space-y-4">
            ...
            {selectedType === 'ISSUE' ? (
              // Issue transaction - show Paid and Unpaid fields side by side
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    control={form.control}
