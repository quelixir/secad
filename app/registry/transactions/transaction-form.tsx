    ...
    defaultValues: {
      ...
      quantity:
        transaction?.quantity !== undefined
          ...
          : "",
      paidPerSecurity:
        transaction?.amountPaidPerSecurity !== undefined
          ? transaction.amountPaidPerSecurity.toString()
          : "",
      unpaidPerSecurity:
        transaction?.amountUnpaidPerSecurity !== undefined
      ...
      postedDate: transaction?.postedDate
        ? new Date(transaction.postedDate).toISOString().split("T")[0]
  ...
  const onSubmit = async (values: TransactionFormValues) => {
    try {
      ...
      const requestData = {
        ...
        pricePerSecurity: values.paidPerSecurity
          ? parseFloat(values.paidPerSecurity)
          : undefined,
        unpaidPerSecurity: values.unpaidPerSecurity
          ? parseFloat(values.unpaidPerSecurity)
          : undefined,
        currency: values.currency,
        postedDate: values.postedDate
          ? new Date(values.postedDate).toISOString()
          : undefined,
        fromMemberId:
          values.type === "ISSUE" ? null : values.fromMemberId || undefined,
        toMemberId: values.toMemberId || undefined,
      };

      const url = transaction
        ? `/api/registry/transactions/${transaction.id}`
        : "/api/registry/transactions";
  ...
  const getTransactionTypeDescription = (type: string) => {
    switch (type) {
      ...
      case "RETURN_OF_CAPITAL":
        return "Return capital to members";
      case "CAPITAL_CALL":
        return "Call for additional capital from members";
      default:
        return "";
    }
  };
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Popover
                    open={reasonCodeOpen}
                    onOpenChange={setReasonCodeOpen}
                  >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Popover
                      open={securityClassOpen}
                      onOpenChange={setSecurityClassOpen}
                    >
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button
                      ...
                      <FormDescription>
                        ...
                        {(() => {
                          ...
                          if (Number.isInteger(total)) {
                            ...
                            total.toString().split(".")[1]?.length <= 2
                          ) {
                            return `${total.toFixed(2)} ${currencyCode}`;
                          } else {
                            return `${total
                              .toFixed(5)
                              .replace(/\.?0+$/, "")} ${currencyCode}`;
                          }
                        })()}
                      </FormDescription>
                      <FormMessage />
                    ...
                    <FormItem>
                      ...
                      <FormDescription>
                        ...
                        {(() => {
                          const qty = parseFloat(quantity || "0") || 0;
                          const unpaid =
                            parseFloat(unpaidPerSecurity || "0") || 0;
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Total: {calculateTotal()}</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              {(selectedType === "TRANSFER" ||
                ...
                selectedType === "RETURN_OF_CAPITAL" ||
                selectedType === "CAPITAL_CALL") && (
                <FormField
                  control={form.control}
                  name="fromMemberId"
                  render={({ field }) => (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="e.g., TXN-001, ISS-2024-001"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
