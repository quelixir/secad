...
const bulkTransactionSchema = z.object({
    ...
    if (data.type === 'ISSUE') {
        ...
        return data.transactions.every(t => t.fromMemberId && t.toMemberId && t.fromMemberId !== t.toMemberId) // Must have both members and they must be different
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>
                                    Add multiple transactions with different members and quantities
                                </CardDescription>
                            </div>
                            <Button type="button" onClick={addTransaction} variant="outline" size="sm">
                            ...
                            <div key={field.id} className="border rounded-lg p-4 space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input placeholder="Number of securities" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Paid per Security ({selectedCurrency})</FormLabel>
                                                <FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Unpaid per Security ({selectedCurrency})</FormLabel>
                                                <FormControl>
                                                    <Input placeholder="0.00" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Reference</FormLabel>
                                                <FormControl>
                                                    <Input placeholder="Individual reference" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Description</FormLabel>
                                            <FormControl>
                                                <Textarea placeholder="Individual description" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
