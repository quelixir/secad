...
export default function MembersPage() {
  ...
  const filteredMembers = members.filter((member) => {
    ...
    const fullName = `${member.givenNames || ""} ${
      member.familyName || ""
    }`.toLowerCase();
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Add, edit, and manage members</CardDescription>
              </div>
                                  ...
                                  <PopoverContent className="w-auto p-2">
                                    ...
                                    {holding.securityClass.symbol && (
                                      <div className="text-xs text-muted-foreground">
                                        Symbol: {holding.securityClass.symbol}
                                      </div>
                                    )}
                                    <div className="text-xs text-muted-foreground">
                                      Balance:{" "}
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  remove all associated holdings and
                                  transactions.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
