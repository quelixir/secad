                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                            ...
                            <div className="bg-muted/50 rounded-lg p-4">
                                <div className="text-2xl font-bold">{totalSecurities.toLocaleString(getLocale(), getLocaleOptions())}</div>
                                <div className="text-sm text-muted-foreground">Total Securities</div>
                            </div>
                            <div className="bg-muted/50 rounded-lg p-4">
                                <div className="text-2xl font-bold">{totalTranches.toLocaleString(getLocale(), getLocaleOptions())}</div>
                                    ...
                                    <TableRow key={securityClass.id}>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-1">
                                                ...
                                                {securityClass.trancheCount.toLocaleString(getLocale(), getLocaleOptions())}
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                            {securityClass.memberCount.toLocaleString(getLocale(), getLocaleOptions())}
                                        </TableCell>
                                        <TableCell>
                                            <div className="flex gap-1">
