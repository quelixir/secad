...
export default function SecuritiesPage() {
  ...
  const [editingSecurity, setEditingSecurityClass] =
  ...
  const filteredSecurityClasses = securityClasses.filter((securityClass) => {
    ...
    if (searchTerm) {
      ...
      const matchesSearch =
        securityClass.name.toLowerCase().includes(searchLower) ||
                  ...
                  <TableCell colSpan={10} className="text-center py-8">
                    <div className="text-muted-foreground">
                      {searchTerm
                        ...
                        : "No securities found for this entity."}
                    </div>
                    {!searchTerm && (
                      <Button
                        variant="outline"
                  ...
                  <TableRow key={securityClass.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Badge
                          variant={
                            securityClass.isActive ? "default" : "secondary"
                          }
                        >
                        ...
                        {!securityClass.isArchived ? (
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Are you sure you want to archive this security
                                  class? Archived classes are hidden from new
                                  transactions but remain accessible for
                                  historical records.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                  onClick={() =>
                                    handleArchive(securityClass.id, "archive")
                                  }
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                <AlertDialogTitle>
                                  Unarchive Security Class
                                </AlertDialogTitle>
                                <AlertDialogDescription>
                                  Are you sure you want to unarchive this
                                  security class? It will become available for
                                  new transactions again.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction
                                  onClick={() =>
                                    handleArchive(securityClass.id, "unarchive")
                                  }
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                class? This action cannot be undone and will
                                also remove all associated holdings and
                                transactions.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
