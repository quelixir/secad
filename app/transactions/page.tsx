...
import { Plus, Search, ArrowRightLeft, TrendingUp, TrendingDown, Repeat, Building2 } from 'lucide-react'
        ...
        <div className="space-y-8">
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              Please select an entity from the dropdown in the navigation bar to view its transactions.
            </p>
          </div>
        </div>
      </MainLayout>
          ...
          <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
            ...
            <DialogContent className="max-w-3xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Issue securities, transfer between members, or process redemptions for {selectedEntity.name}
                </DialogDescription>
              </DialogHeader>
              <TransactionForm entities={entities} selectedEntity={selectedEntity} onSaved={handleTransactionSaved} />
            </DialogContent>
          </Dialog>
        </div>
